  ...
  <nav class="cyan lighten-5 nav-wrapper nav-bar">
    <ul>
      ...
      <li class="right hide-on-med-and-down">
        <!-- Dropdown Trigger -->
        <a class="dropdown-trigger black-text dropdown-btn center" href="#!" data-target="dropdown1" ref="dropdown">{{
          user ? user.name : '' }}<i class="material-icons right">arrow_drop_down</i></a>
        ...
        <ul id="dropdown1" class="dropdown-content">
          ...
          <li>
            <a href="#!" @click.prevent="logOut">Выйти<i class="material-icons">cancel</i></a>
          </li>
        </ul>
      </li>
    </ul>
